...
export function applySettings(root, settings) {
  ...
  const variables = {
    '--dinkflix-hero-backdrop-fit': settings.backdropFit.toLowerCase(),
    '--dinkflix-hero-backdrop-focus': `${settings.backdropFocusX}% ${settings.backdropFocusY}%`,
    '--dinkflix-hero-backdrop-opacity': String(settings.backdropOpacity / 100),
    '--dinkflix-hero-button-height': `${settings.buttonHeight}px`,
    '--dinkflix-hero-button-radius': cornerRadius,
    '--dinkflix-hero-content-max-width': `${settings.contentMaxWidth}px`,
    '--dinkflix-hero-description-color': settings.descriptionColor,
    '--dinkflix-hero-description-lines': String(settings.descriptionLines),
    '--dinkflix-hero-description-size': `${settings.descriptionSize}px`,
    '--dinkflix-hero-description-weight': String(settings.descriptionWeight),
    '--dinkflix-hero-desktop-height': `${settings.desktopHeight}vh`,
    '--dinkflix-hero-mobile-height': `${settings.mobileHeight}vh`,
    '--dinkflix-hero-primary-background': settings.primaryButtonBackgroundColor,
    '--dinkflix-hero-primary-opacity': `${settings.primaryButtonOpacity}%`,
    '--dinkflix-hero-primary-text': settings.primaryButtonTextColor,
    '--dinkflix-hero-secondary-background': settings.secondaryButtonBackgroundColor,
    '--dinkflix-hero-secondary-opacity': `${settings.secondaryButtonOpacity}%`,
    '--dinkflix-hero-secondary-text': settings.secondaryButtonTextColor,
    '--dinkflix-hero-title-color': settings.titleColor,
    '--dinkflix-hero-title-size': `${settings.titleSize}px`,
    '--dinkflix-hero-title-transform': settings.titleCase === 'Uppercase' ? 'uppercase' : 'none',
    '--dinkflix-hero-title-weight': String(settings.titleWeight),
    '--dinkflix-hero-transition-duration': `${settings.transitionDurationMs}ms`,
    '--dinkflix-hero-vignette-opacity': String(settings.vignetteStrength / 100),
  };
