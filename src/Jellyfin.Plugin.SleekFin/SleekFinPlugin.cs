...
public sealed class SleekFinPlugin : BasePlugin<PluginConfiguration>, IHasWebPages
{
    ...
    public override string Description => "DINKFLIX is a custom Jellyfin experience based on SleekFin, with an original mint-accented visual layer. SleekFin remains credited as the underlying project.";
