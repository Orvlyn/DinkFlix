...
/// <summary>
/// File Transformation callback that adds the DINKFLIX Web assets to Jellyfin's index.html.
/// </summary>
public static class WebFileTransformation
{
    ...
    private const string FrontendVersion = "2.1.0";

    /// <summary>
    /// Receives the File Transformation payload and returns the transformed index.html.
    /// </summary>
    /// <param name="input">File Transformation request payload.</param>
    /// <returns>The transformed HTML, or the original HTML when no safe transformation is possible.</returns>
