...
assert version_match.group(1) == "8.5.0.0"
...
assert "DINKFLIX-WEB-85-START" in wf
assert "DINKFLIX-WEB-82-START" in wf
assert '8.5.0.0' in wf
...
assert 'Version>8.5.0.0<' in csproj
